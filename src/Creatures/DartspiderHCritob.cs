...
sealed class DartspiderHCritob : Critob
{
    public DartspiderHCritob() : base(CreatureTemplateType.DartspiderH)
    {
        ...
        base.RegisterUnlock(KillScore.Configurable(7), SandboxUnlockID.DartspiderH, null, 0);
    ...
    public override CreatureTemplate CreateTemplate()
    {
        ...
        CreatureTemplate creatureTemplate = new CreatureFormula(CreatureTemplate.Type.SpitterSpider, base.Type, "DartspiderH")
        {
    ...
    {
        return new DartAI(acrit, acrit.world);
    }
