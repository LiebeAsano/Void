...
public class LWMimicAI : ArtificialIntelligence, IUseARelationshipTracker, IAINoiseReaction
{
    ...
    public LWMimicAI.LurkTracker lurkTracker;

    public LWMimicstarfish star => creature.realizedCreature as LWMimicstarfish;

    public LWMimicAI(AbstractCreature creature, World world)
        : base(creature, world)
    {
        star.AI = this;
        ...
        this.lurkTracker = new LWMimicAI.LurkTracker(this, this.star);
    ...
    public override void Update()
    {
        ...
        /*if (this.lurkTracker != null && this.behavior == Behavior.Hunt && base.preyTracker.MostAttractivePrey != null /*&& this.runSpeed < 0.1f && this.star.abstractCreature.pos.Tile.FloatDist(base.preyTracker.MostAttractivePrey.BestGuessForPosition().Tile) > 17f)
        {
            this.behavior = Behavior.Lurk;
        }*/
    ...
    public void ReactToNoise(NoiseTracker.TheorizedSource source, InGameNoise noise)
    {
        ...
        {
            (star.graphicsModule as LWMimicGraphics).ReactToNoise(source, noise);
        }
    ...
    public class LurkTracker : AIModule
    {
        ...
        public LurkTracker(ArtificialIntelligence AI, LWMimicstarfish star) : base(AI)
        {
            this.star = star;
