...
namespace VoidTemplate;
    ...
    sealed class LWMimicstarfishCritob : Critob
    {
            public LWMimicstarfishCritob() : base(CreatureTemplateType.LWMimicstarfish)
        {
            base.Icon = new SimpleIcon("LWMimicstarfish_Icon", new Color(1f, 0.8f, 0.8f));
        ...
        public override IEnumerable<string> WorldFileAliases()
        {
            ...
            CreatureTemplate creatureTemplate = new CreatureFormula(this)
            {
            ...
            creatureTemplate.daddyCorruptionImmune = true;
            ...
            {
                return new LWMimicAI(acrit, acrit.world);
            }

            public override Creature CreateRealizedCreature(AbstractCreature acrit)
            {
                return new LWMimicstarfish(acrit, acrit.world);
            }
        ...
        {
            return new LWMimicstarfish.StarState(acrit);
            {
