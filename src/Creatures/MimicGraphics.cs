...
namespace VoidTemplate;
    ...
    //DaddyGraphics InitiateGraphicsModule dummy dead TubeEffectColor eyesClosed Colorleg eyeColor/*
    public class MimicGraphics : GraphicsModule
    {
        ...
        public MimicGraphics(PhysicalObject ow) : base(ow, false)
        {
            ...
            int num = 0;
            int num2 = 0;
            this.legGraphics = new MimicGraphics.StarLegGraphic[this.star.tentacles.Length];
            for (int i = 0; i < this.legGraphics.Length; i++)
            {
                this.legGraphics[i] = new MimicGraphics.StarLegGraphic(this, i, num2);
        ...
        public MimicGraphics.StarLegGraphic[] starlegGraphics;
        ...
        public MimicGraphics.StarLegGraphic[] legGraphics;
        ...
        public class Eye : MimicGraphics.DaddyBubbleOwner
        {
            ...
            public Eye(MimicGraphics owner, int index)
            {
                this.index = index;
                this.owner = owner;
        ...
        public abstract class StarTubeGraphic : RopeGraphic
        {
            ...
            public StarTubeGraphic(MimicGraphics owner, int segments, int firstSprite) : base(segments)
            {
                this.owner = owner;
        ...
        public class StarLegGraphic : MimicGraphics.StarTubeGraphic
        {
            ...
            public StarLegGraphic(MimicGraphics owner, int tentacleIndex, int firstSprite) : base(owner, (int)(owner.star.tentacles[tentacleIndex].idealLength / 10f), firstSprite)
            {
                this.tentacleIndex = tentacleIndex;
                this.sprites = 1;
                int num = (int)(owner.star.tentacles[tentacleIndex].idealLength / 10f);
                this.bumps = new MimicGraphics.StarTubeGraphic.Bump[num / 2 + Random.Range(5, 8)];
                for (int i = 0; i < this.bumps.Length; i++)
                {
                    ...
                    this.bumps[i] = new MimicGraphics.StarTubeGraphic.Bump(new Vector2(Mathf.Lerp(-1f, 1f, Random.value) * 3f * num2, Mathf.Lerp(Mathf.InverseLerp(0f, (float)num, (float)(num - 20)), 1f, num2)), Mathf.Lerp(Random.value, num2, Random.value) * (1f), (Random.value < Mathf.Lerp(0f, 0.6f, num2)) ? Mathf.Lerp(0.2f, 0.8f, Mathf.Pow(Random.value, Mathf.Lerp(1.5f, 0.5f, num2))) : 0f);
                    this.sprites++;
                    if (this.bumps[i].eyeSize > 0f)
                    {
                        this.sprites++;
