...
internal sealed class Mimicstarfish : DaddyLongLegs
{
    ...
    internal Mimicstarfish(AbstractCreature abstractCreature, World world) : base(abstractCreature, world)
    {
        ...
        {
            this.tentacles[num17] = new DaddyTentacle(this, this, base.bodyChunks[num17 % base.bodyChunks.Length], 350f, num17, Custom.DegToVec(Mathf.Lerp(0f, 360f, (float)num17 / (float)this.tentacles.Length)));
