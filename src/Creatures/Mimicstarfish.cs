...
internal sealed class Mimicstarfish : DaddyLongLegs
{
    ...
    internal Mimicstarfish(AbstractCreature abstractCreature, World world) : base(abstractCreature, world)
    {
        ...
        {
            float num4 = i / (float)(base.bodyChunks.Length - 1);
        ...
        num12 = Mathf.Lerp(this.SizeClass ? 3000f : 1600f, tentacles.Length * (this.SizeClass ? num11 : 300f), 0.5f);

        List<float> list3 = [];
        for (int num13 = 0; num13 < this.tentacles.Length; num13++)
        {
            list3.Add(num12 / tentacles.Length);
        }
        ...
        {
            this.tentacles[num17] = new DaddyTentacle(this, base.bodyChunks[num17 % base.bodyChunks.Length], 350f, num17, Custom.DegToVec(Mathf.Lerp(0f, 360f, num17 / (float)this.tentacles.Length)));
