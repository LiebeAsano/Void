...
namespace VoidTemplate.Objects.PomObjects
{
    internal class VultureTriggerSpawner : UpdatableAndDeletable
    {
        ...
        public VultureTriggerSpawner(Room room, PlacedObject pObj)
        {
            IsActive = false;
        ...
        {
            RegisterFullyManagedObjectType(managedFields, typeof(VultureTriggerSpawner), "Vulture Spawner", "The Void");
        ...
        private void SpawnVulture()
        {
            ...
            SpawnedVultureDataCWT.Add(abstractVultureCreature, new SpawnedVultureData(isAlbino: false));
