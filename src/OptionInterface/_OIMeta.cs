...
public static class _OIMeta
{
	...
	public static void Initialize()
	{
        ...
        OptionAccessors.cfgFallDamage = voidOI.config.Bind<bool>(uniqueprefix + "FallDamage", true, new ConfigurableInfo("Fall damage for all creatures", tags: "Fall Damage"));
