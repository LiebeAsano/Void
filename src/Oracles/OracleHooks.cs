                ...
                case 5:
                    {
                        if (self.action != MoreSlugcatsEnums.SSOracleBehaviorAction.Pebbles_SlumberParty)
                        {
                            ...
                            if (!fivePebblesGetOut)
                            {
                                ...
                                self.dialogBox.NewMessage(self.Translate("I am not here to help everyone and everything. Call off your kin and head west."), 60);
                                self.dialogBox.NewMessage(self.Translate("I have already opened the gate to leave my complex."), 60);
                            }
                            miscData.SSaiConversationsHad--;
