...
public static class Utils
{
    ...
    public static bool IsVoid(this Player p) => p.playerState.slugcatCharacter == VoidEnums.SlugcatID.Void;
    public static bool IsViy(this Player p) => p.playerState.slugcatCharacter == VoidEnums.SlugcatID.Viy;
    public static bool AreVoidViy(this Player p) => p.playerState.slugcatCharacter == VoidEnums.SlugcatID.Void || p.playerState.slugcatCharacter == VoidEnums.SlugcatID.Viy;
